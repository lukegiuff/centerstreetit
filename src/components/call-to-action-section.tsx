        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Don&apos;t leave your IT infrastructure to chance. Contact Center Street I.T. today to learn how our comprehensive managed services can transform your business operations, enhance security, and drive growth.
            </p>
