...
Applications no one actively relies on anymore
Overlapping tools that serve the same purpose
Legacy software that’s been around “forever”
User access for former employees that never got removed
Temporary fixes that quietly became part of daily operations
